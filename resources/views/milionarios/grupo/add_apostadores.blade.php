...
@section('milion')
<div class="row">
    <div class="card-panel #8bc34a light-green"><i class="material-icons">person</i> Apostadores</div>

    <a href="/grupo" class=" btn waves-effect waves-light"><i class="material-icons right">arrow_back</i>Voltar</a>    
